...
package Tempo::Display::Chart::Quarterly::ByFootwear;

use parent 'Tempo::Display::Chart';

use JBD::Core::stern;
use Tempo::Color 'color_list';
use Tempo::Data qw(DATE FOOT);
use JSON 'to_json';
...
# @param Tempo::Display::Chart::Quarterly::ByFootwear $this
...
sub chart {
    ...
    my @colors = color_list __PACKAGE__ . time, @$footwear;
